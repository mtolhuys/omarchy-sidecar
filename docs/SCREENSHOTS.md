...
Repository media must come from the current `v1013` graph and contain no real credentials, QR secrets, device names, tailnet names, paths, URLs, window titles, or private desktop content.
