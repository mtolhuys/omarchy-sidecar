...
grep -F 'sidecar-web-v1011-final' /tmp/sidecar-phase0/web/dist/sw.v1011.js >/dev/null && \
test ! -e /tmp/sidecar-phase0/service/v1008 && test ! -e /tmp/sidecar-phase0/bar-widget/v1008"
  ...
  sleep 0.8
  capture_console "success-sidecar-v1011-phase0-notification"
  ...
  capture_console "success-sidecar-v1011-contracts-locked"
